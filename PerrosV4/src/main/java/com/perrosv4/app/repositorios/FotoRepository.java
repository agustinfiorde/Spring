...
public interface FotoRepository extends JpaRepository<Foto, String>{
	...
	@Query("SELECT a from Foto a ORDER BY a.fileName DESC")
	public Page<Foto> searchAll(Pageable pageable);
	...
	public Page<Foto> searchAll(Pageable pageable, @Param("q") String q);
